...
const Login = ( { setUser } ) => {
    ...
    return (
        <div className="min-h-screen bg-[#030712] flex flex-col items-center justify-center p-4">
            <div className="w-full max-w-md bg-white/5 backdrop-blur-xl border border-white/10 p-10 rounded-3xl shadow-[0_0_100px_rgba(0,0,0,0.5)] relative overflow-hidden group">
                ...
                <div className="mb-10 text-center">
                    ...
                    <p className="text-slate-500 text-[11px] uppercase tracking-[0.2em] font-mono leading-relaxed">
                        <span className="text-cyan-500/60 font-bold font-cursive lowercase">share your experiences with others</span>
                    </p>
                </div>
                ...
                <form onSubmit={handleLogin} className="space-y-8">
                    ...
                    >
                        {isLoading ? "Checking..." : "Confirm Identity"}
                    </button>
                </form>
                ...
                <div className="mt-10 text-center border-t border-white/5 pt-6">
                    <p className="text-slate-500 text-[10px] uppercase tracking-wider">
                        New User? 
                        <Link to="/register" className="ml-2 text-white hover:text-cyan-400 underline underline-offset-4 ">
                            Get Started
                        </Link>
                    </p>
                </div>
